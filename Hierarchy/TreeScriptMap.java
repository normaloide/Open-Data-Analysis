// Questo script genera un file json contenente l'intero dataset in forma gerarchica temporale, in cui le foglie di ciascun osservazione (giorno) sono le sue features, utilizzando formato name-value per ciascuna foglia, escludendo le voci CO e Valutazione.

import java.util.Scanner;
import java.util.Arrays;
import java.io.File;

public class TreeScriptMap
	{
		...
		try
			...
			for (int yCount = 2008; signalMore; yCount++)
				...
				while (signalMoreM)
					...
					// ATTENZIONE: Il CO ha proporzioni troppo estreme per essere inserito nella treemap.
